...
<div id="slider1_container" style="visibility: hidden; position: relative; margin: 0 auto; width: 1140px; height: 442px; overflow: hidden;">
    ...
    <div data-u="loading" class="jssorl-009-spin" style="position:absolute;top:0px;left:0px;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
        <img style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="{{url('/svg/loading/static-svg/spin.svg')}}" />
    </div>
    ...
    <div data-u="slides" style="position: absolute; left: 0px; top: 0px; width: 1140px; height: 442px;
         overflow: hidden;">
        <div>
            <img data-u="image" src="{{url('/img/gallery/980x380/001.jpg')}}" />
        </div>
        <div>
            <img data-u="image" src="{{url('/img/gallery/980x380/002.jpg')}}" />
        </div>
        <div>
            <img data-u="image" src="{{url('/img/gallery/980x380/003.jpg')}}" />
        </div>
        <div>
            <img data-u="image" src="{{url('/img/gallery/980x380/004.jpg')}}" />
        </div>
    </div>
